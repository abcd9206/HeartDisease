...
model_path = 'D:\Kuliah\SEMESTER 5\ML\pertemuan 2\prak 2\Tugas_A_11768'
mdoel=os.path.join(model_path,'GBT_heartDisease_model.pkl')
...
input_data = [[input_sex_F, input_sex_M, 
               input_cpain_ASY, input_cpain_ATA, input_cpain_NAP, input_cpain_TA, 
               input_restecg_LVH, input_restecg_NORMAL, input_restecg_ST,
               input_anginaN, input_anginaY, input_STslope_down, input_STslope_flat, input_STslope_up,
               Age, RestingBP, Cholesterol, input_fastbs, MaxHR, Old_peak]]
